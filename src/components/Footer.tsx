...
const Footer = () => {
  ...
  const socialLinks = [
    { icon: Github, href: "https://github.com/millind-yadav", label: "GitHub" },
    {
      icon: Linkedin,
    ...
    {
      icon: InstagramIcon,
      href: "https://www.instagram.com/miilliindd",
      label: "Instagram",
    },
    {
      icon: Twitter,
      href: "https://x.com/47e59733c30549f?s=21",
      label: "Twitter / X",
    },
    {
      icon: BookOpen,
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          ...
          <div className="md:col-span-2 space-y-6">
            <h2 className="text-2xl font-black uppercase tracking-tighter italic">
              MILIND RAMSINGH YADAV<span className="text-foreground">.....</span>
            </h2>
            <p className="text-foreground/60 max-w-sm leading-relaxed">
              AI &amp; ML Engineer specialising in production-grade Generative AI
              on AWS. Building the next generation of intelligent agentic systems.
            </p>
