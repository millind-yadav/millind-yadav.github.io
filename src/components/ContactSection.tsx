...
const ContactSection = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    const phoneNumber = "+447823853633";
        ...
        <div className="space-y-8 md:space-y-10">
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center gap-4 p-4 border border-foreground/10 bg-white/50 hover:border-black transition-colors duration-300">
              ...
              <div>
                ...
                <p className="font-mono text-sm">+44 7823853633</p>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex gap-4">
              {[
                { Icon: Github, href: "https://github.com/millind-yadav" },
                { Icon: Linkedin, href: "https://linkedin.com/in/millind-yadav" },
                { Icon: InstagramIcon, href: "https://www.instagram.com/miilliindd" },
                { Icon: Twitter, href: "https://x.com/47e59733c30549f?s=21" },
                { Icon: BookOpen, href: "https://medium.com/@milindyadav98" },
              ].map(({ Icon, href }, i) => (
                <a
                  key={i}
                  href={href}
